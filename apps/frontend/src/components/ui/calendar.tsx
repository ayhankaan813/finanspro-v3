        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    "h-6 w-6 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1"
                ),
                button_next: cn(
                    buttonVariants({ variant: "outline" }),
                    "h-6 w-6 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1"
                ),
            ...
            components={{
                Chevron: ({ orientation, ...props }) => {
                    if (orientation === "left") return <ChevronLeft className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
